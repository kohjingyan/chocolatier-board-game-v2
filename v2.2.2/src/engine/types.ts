...
export type GameState = {
  ...
  contributedMarkup: Record<string, number>
  poolMarkup: Record<string, { sellerId: string; amount: number }>
...
export type ScoreSnapshot = { stage: number; round: number; scores: Record<string, number> }
...
type ActionBody =
  ...
  | { type: 'CALL_FOR_BID' }
  | { type: 'ROLL_DICE' }
  | { type: 'CONTRIBUTE'; cardUid: string; type: 'CONTRIBUTE'; cardUid: string; markup?: number; actorId?: string }
